...
import { Check, ChevronRight, User, Mail, Phone, Calendar, MapPin, Users, AlertCircle } from 'lucide-react';
...
const BookingForm: React.FC = () => {
  ...
  const { bookingData, setBookingPersonsData } = useBooking();
                  ...
                  <div className="bg-white rounded-xl shadow-lg p-8 mb-6">
                    ...
                    <div className="flex flex-col md:flex-row gap-6 mb-6">
                      ...
                      <div className="md:w-2/3">
                        ...
                        <p className="text-sm text-gray-600 mb-4">Formule {packageData.id}</p>
                      ...
                      <ul className="mb-6">
                        {bookingData.options.map((option) => (
                          <li key={option.id} className="flex justify-between py-2 border-b border-gray-100">
                            ...
                            <span className="font-medium">{option.price} DT</span>
                          </li>
                        ))}
                      </ul>
                    ) : (
                    ...
                    <div className="bg-desert-50 rounded-lg p-4 mb-6">
                      ...
                      {bookingData.options.length > 0 && (
                        <div className="flex justify-between mb-2">
                          ...
                          <span>
                            {bookingData.options.reduce((sum, opt) => sum + opt.price, 0)} DT
                          </span>
                        </div>
                      )}
                      ...
                      <div className="flex justify-between font-bold text-lg pt-2 border-t border-gray-300">
                        <span>Total:</span>
                        <span className="text-secondary">{bookingData.totalPrice * watchNumberOfPeople} DT</span>
                      </div>
                    </div>
                  </div>
